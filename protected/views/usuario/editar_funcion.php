	...
	<div class="col-md-6">
		...
		<?php
			$form = $this->beginWidget('CActiveForm', array(
				'method'=>'post',
				'action'=>Yii::app()->createUrl('usuario/editar_funcion?idFuncion='.$data['id']),
				'id'=>'form',
		 ...
		 <div class="form-group">
			<?php
				...
				echo $form->textField($model, 'hora_funcion', array('class'=>'form-control',
					'value'=>$data['hora_funcion']));
		...
		<div class="form-group">
			<?php
				echo CHtml::submitButton('Actualizar Datos', array('class'=>'btn btn-outline-success'));
			?>
		</div>
